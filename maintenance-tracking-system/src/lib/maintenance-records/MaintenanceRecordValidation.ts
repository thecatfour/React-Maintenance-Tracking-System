...
export const M_RECORD_ERROR_MSG = {
    ...
    partsReplaced: {trailingWhitespace: "A part cannot only be whitespace"},
}
...
export const mRecordSchema = z.object({
    ...
    hoursSpent: z.string().nonempty({message: M_RECORD_ERROR_MSG.hoursSpent.required})
    ...
    partsReplaced: z.array(z.string()).optional()
        .refine(s => {
            ...
            return true;
        }, {message: M_RECORD_ERROR_MSG.partsReplaced.trailingWhitespace}),
